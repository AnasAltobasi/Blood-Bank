...
$query="SELECT DISTINCT * FROM search_blood";
...
<head>
    ...
    <title><?php echo $expr['List Of People Who Searched']?></title>
...
<div class="page_info">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-6" style="text-align:right;"><?php echo $expr['Profile Admin']?><span class="sep"> / </span><span class="current"><?php echo $expr['List Of People Who Searched']?></span></div>
                </div>
            </div>
        </div>
</section>
<div class="container">
  <h2><?php echo $expr['List Of People Who Searched']?></h2>
  <p><?php echo $expr['Search For Any Blood Type Or City Of Doners']?></p>  
...
echo"<tr><td>".$num++."</td><td>".$row['PhoneNumber']."</td><td>".$row['Governorate']."</td><td>".$row['BloodType']."</td><td>".$row['ImportantInformation']."</td><td>"."&nbsp;<a class='btn btn-success' href='tel:{$row["PhoneNumber"]}'>{$expr['Call Me']}</a>"."</td></tr>";
}  
//echo "</table>";
}
?>
