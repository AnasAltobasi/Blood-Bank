...
<head>
    ...
    <title><?php echo $expr['List Of People Who Sends Messages']?></title>
...
<div class="page_info">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-6" style="text-align:right;"><?php echo $expr['Profile Admin']?><span class="sep"> / </span><span class="current"><?php echo $expr['List Of People Who Sends Messages']?></span></div>
                </div>
            </div>
        </div>
</section>
<div class="container">
  <h2><?php echo $expr['List Of People Who Sends Messages']?></h2>
  <p><?php echo $expr['Search For Any User By Subject Or Email Or Number Phone']?></p>  
...
<th><?php echo $expr['Address']?></th>
<th><?php echo $expr['Subject']?></th>
...
echo"<tr><td>".$num++."</td><td>".$row['Name']."</td><td>".$row['Email']."</td><td>".$row['Phone']."</td><td>".$row['Address']."</td><td>".$row['Subject']."</td><td>".$row['Message']."</td><td>"."&nbsp;<a class='btn btn-success' href='tel:{$row["Phone"]}'>{$expr['Call Me']}</a>&nbsp;<a href=mailto:{$row["Email"]}><button type='button' class='btn btn-info' >{$expr['Send Email']}</button></a>"."</td></tr>";
}  
//echo "</table>";
}
?>
  ...
  <p><?php echo $expr['This Is The Feed Back From Users']?></p>
</div>        
